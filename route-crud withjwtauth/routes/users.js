...
router.get("/email/:email",(req,res)=>{
  ...
  let filtered_email = users.filter((user) => user.email === email);
  res.send(filtered_email)
});
...
router.get("/lastName/:lastName", (req, res) => {
  ...
  filtered_lastName = users.filter((user)=> user.lastName === lastName);
  res.send(filtered_lastName);
})

router.get("/DOB/:DOB", (req, res) => {
  dob = req.params.DOB;
  filtered_DOB = users.filter((user) => user.DOB === dob);
